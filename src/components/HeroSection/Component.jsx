...
const Component = ({
  ...
  return (
    <div className="wrapper-div-20811189 relative m-auto p-[0px] box-border">
      <div className=" max-w-[1440px] w-full box-border min-h-[597px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-wrap justify-center items-center gap-[48px] p-[80px_0px_80px__0px] bg-[#ffffffff]  ">
        {/* Splash Text1 */}

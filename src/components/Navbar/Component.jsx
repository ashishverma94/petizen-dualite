...
const Navbar = ({
  ...
  return (
    <div className=" relative m-auto p-[0px] box-border">
      <div className="   w-full  box-border min-h-[99px] opacity-[1] z-[1]  rotate-[0deg]   overflow-hidden flex flex-nowrap justify-between items-center content-space-between  bg-[#ffffffff]  ">
        {/* Logo1 */}
        ...
        {/* Nav-links1 */}
        <section className="  max-w-[272px] min-h-[59px] w-full box-border  opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-start items-center gap-[20px] p-[0px_0px_0px__0px]  ">
          <div className=" max-w-[58px] min-h-[19px] w-full box-border  opacity-[1] z-[0]  rotate-[0deg]   flex flex-nowrap justify-start items-start gap-[20px] p-[0px_0px_0px__0px]  ">
          ...
          <div className="button-container w-full box-border min-h-[59px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[8px] p-[16px_0px_16px__0px] rounded-tl-[99px] rounded-tr-[99px] rounded-br-[99px] rounded-bl-[99px] bg-[#f9655eff]">
            <div className=" w-[20px]  min-h-[20px] opacity-[1] z-[0]  rotate-[0deg] overflow-hidden  ">
              <img

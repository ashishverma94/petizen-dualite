    ...
    <div className="wrapper-div-20821149 relative m-auto py-[120px] box-border">
      <div className=" w-full box-border opacity-[1] z-[1]  rotate-[0deg]   flex flex-wrap justify-start items-start gap-[10px] p-[0px_0px_0px__0px]  ">
        ...
        <section className=" w-full box-border  opacity-[1] z-[0]  rotate-[0deg]   flex flex-wrap justify-start items-start gap-[10px] p-[0px_0px_0px__0px]  ">
          <div className=" w-full box-border  opacity-[1] z-[0]  rotate-[0deg]   flex flex-col md:flex-row-reverse justify-start items-center gap-5 md:gap-[140px] p-[0px_0px_0px__0px] bg-[#ffffffff]  ">
            ...
            <div className=" @container w-full box-border min-h-[274px] top-[29.68%] left-[6.32%] opacity-[1] z-[1]  rotate-[0deg]   flex flex-col  justify-center items-center  md:items-start gap-[32px] px-[40px] md:p-[0px_120px_0px__120px]   ">
              <div className=" justify-center items-center   w-full box-border md:pr-[120px] opacity-[1] z-[0]  rotate-[0deg]   text-left leading-[0px]  ">
                <span className={`apply-to-be-an--20811216-0 ${fontLeading}`}>{text1}</span>
              </div>
              <div className="w-[155px] h-[62px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-center items-center gap-[8px] p-[20px_0px_20px__0px] rounded-tl-[99px] rounded-tr-[99px] rounded-br-[99px] rounded-bl-[99px] bg-[#f9655eff]  ">
